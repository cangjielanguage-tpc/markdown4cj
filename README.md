...
1. 下载安装
   ...
   1.本地编译安装 - 准备好DevEco Studio for Windows 6.1.1.280环境
      ...
      编译markdown_arkui
      build -> Make Module `markdownarkui`

      获取har包。har包路径
      markdown_arkui -> build -> outputs -> default -> markdown_arkui.har
...
8. 增量解析会导致上下数据前后文失效(TOC/脚注/标题ID/引用链接)
