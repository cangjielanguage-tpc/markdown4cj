...
主要类和函数接口说明详见 [API](https://gitcode.com/Cangjie-TPC/markdown4cj/blob/markdown4cj_cangjie-plugin_5.1.1.823/doc/feature_api.md)
...
1. 下载安装
   ...
   2. 本地编译安装
      ...
      git checkout markdown4cj_cangjie-plugin_5.1.1.823
      ```
